...
Происхождение и преобразования цифровых файлов описываются в корневом
`ro-crate-metadata.json` по стандарту RO-Crate 1.3. Для локальных файлов там
фиксируются путь, размер, формат, длительность и SHA-256; действия связывают
исходник с результатом и называют использованный инструмент.
